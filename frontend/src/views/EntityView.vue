        ...
        <div class="container mx-auto pt-4 px-4">
            <nav class="w-full">
                <ol class="flex flex-wrap list-reset">
                    <template
                        v-for="(n, index) in entitiesStore.locationtree"
                        :key="n"
                    >
                        <li>
                            <a
                        ...
                        <li
                            v-if="index < entitiesStore.locationtree.length - 1"
                        >
            ...
            <div
                ...
                @click="
                    cameraStore.open(async (files: File[]) => {
                        ...
                        try {
                            const artifactId = await api.uploadArtifact(
                                files[0],
                            );
                            const entity = {
                                name: null,
                            ...
                            console.error('Failed to create entity:', error);
                            toastsStore.add(
                                'Failed to create entity from photo',
                            );
                        }
                    })
                "
        ...
        >
            ...
            >
                ...
                >
                    <!-- Title -->
                    <div
                        class="grid grid-cols-2 w-fit space-x-2 items-baseline mb-4"
                    >
